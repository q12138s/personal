                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <span >
                            <font color="#FFFFFF">欢迎您,${name}</font>
                            </span> 
                        </div>
                    </li>
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">个人信息管理</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath }/tioazhuanupdatestuser" data-index="0">个人信息管理</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="#">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">计划管理</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath }/tiaozhuanPlansList" data-index="0">计划管理</a>
                            </li>
                        </ul>
                    </li>
                        </ul>
