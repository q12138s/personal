					...
					<div class="ibox-content">
						<form method="post" class="form-horizontal" id="addGoodsForm"
							...
							<input type="hidden" name="planid" value = "${plan.planid }"/>
								...
								<div class="col-sm-4">
									<input id="planname" name="planname" type="text" value="${plan.planname}"
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input id="plantime" name="plantime" type="text" value="${plan.plantime}"
										class="form-control"> <br />
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input id="remind" name="remind" type="text" value="${plan.remind}"
										class="form-control"> <br />
								</div>
							</div>
							<div class="form-group">
